...
recording.prototype.toJSON = function (key){
  return {DAG: exportDAG(this), current_node_id:this.current_node_id, root_node_id:this.root_node_id, tutorial_name:this.tutorial_name }; // everything that needs to get stored
 };
